...
if(isset($_POST['add'])){
	...
	$query="INSERT INTO `today_match` (`teama`,`teamb`,`matchDate`,`matchTime`,`center`)
VALUES ('".$_POST['teama']."','".$_POST['teamb']."','".$_POST['date']."','".$_POST['time']."','".$_POST['center']."')";
	$connect->insertion($query);	
		
	$message=successMsg('you have successfully posted todays match ');	
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" style="font-weight:bold;color:#000;font-size:14px">Add Match</div>
                            </div>
                    ...
                    <input type="hidden" name="MAX_FILE_SIZE"/>
						<fieldset>
							...
							<div class="control-group">
							 ...
							 <div class="control-group">
  								<label class="control-label" style="font-size:12px">Match Time<span class="required">*</span></label>
  								<div class="controls">
