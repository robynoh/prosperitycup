                     ...
                     <div class="row-fluid"><?php echo $msg;?>
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" style="font-weight:bold;color:#000;font-size:14px"> News</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                   <div class="table-toolbar">
                                      <div class="btn-group">
                                       ...
                                       <a href="add_news"  class="btn " >Add News </a><i class="icon-plus icon-white"></i>
                                      </div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
								...
								while($rows=SqlArray($result)){?>
                                 ...
                                 <tr class="gradeU">
                                            <td><input name="news[]" type="checkbox" value="<?php echo $rows['news_id'];?>"></td>
                                               ...
                                               <?php echo strip_tags( substr( $rows['content'],0,170)) ;?>...</td>
                                                ...
                                                <td class="center"><div class="btn-group"><a class="btn btn-primary"  style="color:#fff" href="editNews?news_id=<?php echo ucwords($rows['news_id']);?>"><i class="icon-pencil icon-white"></i> Edit</a></div></td>
                                                <td class="center"><div class="btn-group"><a href="delete?news_id=<?php echo $rows['news_id'];?>" class="btn btn-danger" style="color:#fff"><i class="icon-remove icon-white"></i> Delete</a></button></div></td>
                                            </tr>
