...
$news =new news();
	...
	$result  =  ExecuteQuery("SELECT * FROM `today_match`");
                     ...
                     <div class="row-fluid"><?php echo $msg;?>
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left" style="font-weight:bold;color:#000;font-size:14px"> Today Match</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<div class="table-toolbar">
                                      <div class="btn-group">
                                       ...
                                       <a href="add_match"  class="btn " >Add Match </a><i class="icon-plus icon-white"></i>
                                      </div>
								...
								while($rows=SqlArray($result)){?>
                                 ...
                                 <tr class="gradeU">
                                            <td><input name="news[]" type="checkbox" value="<?php echo $rows['match_id'];?>"></td>
												...
												<td><?php echo $rows['matchDate'];?></td>
                                                   ...
                                                   <td class="center"><div class="btn-group"><a href="delete?matchid=<?php echo $rows['match_id'];?>" class="btn btn-danger" style="color:#fff"><i class="icon-remove icon-white"></i> Delete</a></button></div></td>
                                            </tr>
