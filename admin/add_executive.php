...
if($size > 1000000){
	...
	$pass = "executives_photo/".$name.".$ext";
	move_uploaded_file($_FILES['fileField']['tmp_name'],$pass);
	$image = $name.".$ext";
	
	if(ExecuteQuery("insert into executives (exec_id,exec_name,exec_com,filename,position)values(NULL,'".addslashes($_POST['name'])."','".addslashes($_POST['community'])."','".$image."','". addslashes($_POST['position'])."')")){
		$message=successMsg('Executive uploaded successfully ');
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000">Add New Executive</b></div>
                            </div>
					...
					<form action="" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post">
					  ...
					  <div class="control-group">
							...
							<div class="control-group">
  								...
  								<div class="controls">
  									<input type="text" name="community" data-required="1" class="span6 m-wrap"/>
  								</div>
  							</div>
