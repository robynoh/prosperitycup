...
if(isset($_POST['add'])){
	...
	else if(empty($_POST['title']))$message=errorMsg('Please enter Category');
	else if(empty($_POST['image_detail']))$message=errorMsg('Please enter item name');
...
if($size > 1000000){
	...
	$pass = "gallery/".$name.".$ext";
	move_uploaded_file($_FILES['fileField']['tmp_name'],$pass);
	$image = $name.".$ext";
	
	if(ExecuteQuery("insert into gallery (photo_id,filename,title,caption)values(NULL,'".$image."','".addslashes($_POST['title'])."','".addslashes($_POST['image_detail'])."')")){
		$message=successMsg('Photo uploaded successfully ');
	            ...
	            <!-- /wizard -->
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:18px; color:#000">Add Photo</b></div>
                            </div>
					...
					<form action="" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post">
					  ...
					  <div class="control-group">
  							...
  							<div class="control-group">
                                          <label class="control-label" for="textarea2">Enter note </label>
                                          <div class="controls">
                                            <textarea name="image_detail" class="input-xlarge textarea" placeholder="Enter note about photo ..." style="width: 600px; height: 200px"></textarea>
                                          </div>
                                        </div>
