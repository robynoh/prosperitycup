...
if(isset($_GET['phot_id'])){

	
	
	
	
	$resultEdit=ExecuteQuery("select * from gallery  where photo_id='".$_GET['phot_id']."'");
...
if(isset($_POST['update'])){
	...
	if(empty($Filename)){
		...
		ExecuteQuery("update gallery set title='".addslashes($_POST['title'])."',caption='".addslashes($_POST['detail'])."',filename='".$rows_Edit['photo']."' where photo_id='".$_GET['phot_id']."'");
			
		header("location: ".$_SERVER['PHP_SELF']."?phot_id=".$_GET['phot_id']."&&confirmation=updated");
	...
	$date = date("Y-m-d");
	if(ExecuteQuery("update gallery set title='".addslashes($_POST['title'])."', caption='".addslashes($_POST['detail'])."',filename='".$Filename."' where photo_id='".$_GET['phot_id']."'")){
	            ...
	            <!-- /wizard -->
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><b style="font-size:14px; color:#000">Photo Edit</b></div>
                            </div>
                            <div class="block-content collapse in">
                              <?php echo $message;?> <div class="span3" style="margin-left:22%; margin-bottom:10px">
                                      <a href="#" class="thumbnail">
                                        <img src="gallery/<?php echo $rows_Edit['filename'];?>" width="208" height="183">
                                      </a>
					...
					<form action="" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data" method="post">
						<fieldset>
                            ...
                            <div class="control-group">
                                          <label class="control-label" for="textarea2">Caption</label>
                                          <div class="controls">
                                            <textarea name="detail" class="input-xlarge textarea"  placeholder="Enter item description ..." style="width: 600px; height: 200px"><?php echo $rows_Edit['caption'];?></textarea>
                                          </div>
                                        </div>
  							<div class="control-group">
