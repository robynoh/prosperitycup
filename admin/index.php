...
if(isset($_POST['sign'])){	
	...
	$result = ExecuteQuery("select name,email, account_id, acctype from account where email='$username' and password = '$hashPassword'");
...
<html>
  ...
  <body id="login">
    ...
    <div class="container">
	  ...
	  <?php echo $message; ?>
        <h2 class="form-signin-heading" style="font-size:16px;text-align:center"><u> Ijaw National Council</u></h2>
