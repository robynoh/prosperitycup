			...
			<div class="sportsmagazine-main-section">
				<div class="container">
					<div class="row">
					 ...
					 <div class="sportsmagazine-fancy-title-two"><h2>Fixtures <span></span></h2></div>
					
					 
							
							 <div style="padding:10px">
									 <p> <a  target="blank" href="<?php echo $connection->url(); ?>/matchfixtures/MATCH-FIXTURES-AND-SCHEDULES.pdf"><u><b style="color:#090">VIEW AND DOWNLOAD ALL MATCH FIXTURES and  SCHEDULES FOR THE PRELIMINARIES TO QUALIFY FOR SECOND ROUND
