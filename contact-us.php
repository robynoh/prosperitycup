...
$offset = ($page_number-1) * $no_of_records_per_page; 
    ...
    $querypro= "SELECT * FROM `news` order by news_id desc limit $offset ,$no_of_records_per_page ";
...
if(isset($_POST['submit'])){
	...
	$query="INSERT INTO `contact_info` (`name`,`email`,`msg`,`info_date`)
VALUES ('".filter_var($_POST['name'], FILTER_SANITIZE_STRING)."','".filter_var($_POST['email'], FILTER_SANITIZE_STRING)."','".filter_var($_POST['msg'], FILTER_SANITIZE_STRING)."','".date('m-d-Y')."')";
	$connection->insertion($query);	
		
	$message='<div style="padding:10px;font-size:14px;background:#66FFCC;color:#000">You have successfully submitted your message</div> ';	
					...
					<div class="row">
                        ...
                        <!--// Fixture Slider \\-->
						 ...
						 <div class="sportsmagazine-blog sportsmagazine-blog-grid">
						  <div class="sportsmagazine-fancy-title-two"><h2>CONTACT US <span></span></h2></div>
                              <div class="row">
                               ...
                               <form action="" method="POST">
                                    <ul>
                                        <li>
                                            <label>Name:</label>
                                            <p>
                                                <input name="name" value="Type here" type="text" required>
                                        ...
                                        <li>
                                            <label>Email:</label>
                                            <p>
                                                <input name="email" value="Type here" type="text" required>
                                        ...
                                        <li class="full-input">
                                            <label>Message:</label>
                                            <p>
                                                <textarea name="msg" placeholder="Type here" required></textarea>
                                                <span><i class="fa fa-comment"></i></span>
                                            </p>

                                        </li>
                                        <li>
                                            <p><label><input name="submit" value="Submit" type="submit"></label></p>
                                        </li>
                                    </ul>
                                </form>
                            </div>
                        ...
                        <div class="col-md-3">
                            <ul class="sportsmagazine-contact-us-text">
                                <li>
                                    ...
                                    <p>For comments and suggestion send your message by entering the required information in the form field</p>
                                </li>
