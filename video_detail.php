...
$connection->selectDatabase();
	...
	$querypro= "SELECT * FROM `videos` where video_id=".$_GET['vidid'];
				...
				<div class="container">
					<div class="row">
                        ...
                        <aside class="col-md-3">
                            ...
                            <div class="sportsmagazine-widget-heading"><h2>Other Videos</h2></div>
                          <div class="widget widget_popular_post">
                                <ul>
                                <?php echo $connect->other_videos($_GET['vidid']);?>
								<li><span style="font-weight:bold;text-decoration:underline;padding-left:10px"><a href="<?php echo $connection->url(); ?>videos">View All Videos</a></span></li>
								</ul>
                            </div>
                            <!--// Widget Flicker Images \\-->
